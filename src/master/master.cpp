    ...
    class Master: public braft::StateMachine
    {
        public:
            ...
            int start()
            {
                ...
                std::string prefix = "local://" + FLAGS_home + "/" + FLAGS_data_path + "/master";
                    ...
                    ::google::protobuf::Closure* done)
            {
                ...
                // fail
                task.done = new MasterOpClosure(this, request, response, done_guard.release());
                if (FLAGS_check_term)
                {
    ...
    class MasterServiceImpl: public MasterService
    {
        public:
            ...
            void heartbeat(::google::protobuf::RpcController* controller,
                    const ::elasticfaiss::HeartbeatRequest* request, ::elasticfaiss::HeartbeatResponse* response,
                    ::google::protobuf::Closure* done)
            {
                //brpc::ClosureGuard done_guard(done);
